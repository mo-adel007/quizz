      ...
      const sampleAnnouncements = [
        {
          ...
          content:
            "Welcome to the Spring Semester 2025! We hope you are excited about your classes. Please check your schedule and make sure you have all required materials.",
          author: "Dean Johnson",
        ...
        },
        {
          ...
          content:
            "The university library will extend its opening hours during the final exam period. Starting next week, the library will be open 24/7.",
        ...
        },
        {
          ...
          content:
            "Don't miss the Spring Career Fair on March 15. Many top companies will be present to recruit students for internships and full-time positions.",
      ...
      const sampleQuizzes = [
        {
          ...
          description:
            "This quiz covers all material from weeks 1-5. It will help you prepare for the upcoming midterm exam.",
        ...
        },
        {
          ...
          description:
            "Assessment covering Chapter 7: Database Normalization. Focus on 1NF, 2NF, and 3NF concepts.",
        ...
        },
        {
          ...
          description:
            "Submit your group project proposal including team members, project outline, and timeline.",
